...
export function getValidImageUrl(url?: string, fallback: string = 'https://res.cloudinary.com/dzimmsjyx/image/upload/f_auto,q_auto,w_400/mangostore/mangostore/mango-box.jpg'): string {
